local IdleBehavior = require("jotaro.behaviors.idle")
local RushBehavior = require("jotaro.behaviors.rush")
local AttackBehavior = require("jotaro.behaviors.attack")
local ReturnBehavior = require("jotaro.behaviors.return")
